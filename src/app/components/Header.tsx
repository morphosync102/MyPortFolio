  ...
  return (
    <header className={getHeaderClassName()}>
      <div className="relative z-10 mx-auto flex h-full max-w-6xl items-center justify-between px-6 reveal-down">
        <Link
          to="/"
          className="text-xs font-semibold uppercase tracking-[0.35em] text-amber-950"
        >
              ...
              <Link
                ...
                className={cn(
                  ...
                  isNavActive(pathname, item.href)
                    ...
                    : 'text-amber-700 hover:bg-amber-100/80 hover:text-amber-950'
                )}
              >
                {item.label}
              </Link>
        ...
        <div className="flex items-center gap-2">
          {githubLink ? (
            ...
            className="rounded-full border border-amber-200/80 bg-amber-50/90 p-2 text-amber-700 transition-colors hover:bg-amber-200/80 hover:text-amber-950"
